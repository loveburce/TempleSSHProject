package com.elight.teaching.custom.dialog;

import android.content.Context;
import com.elight.teaching.utils.PixelUtils;

/**
 * Created by dawn on 2014/9/23.
 * 提示对话框，有一个确认，一个返回按钮
 */
public class DialogTips extends DialogBase{
    ...
    protected void onBuilding() {
        super.setWidth(PixelUtils.dip2px(mainContext, 300));
        if(hasNegative){
